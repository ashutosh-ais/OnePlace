...
const getStyles = (colors) => StyleSheet.create({
  ...
  sheetTitle: { fontFamily: BOLD, fontSize: RFValue(18), color: colors.text },
  ...
  habitItemTitle: { fontFamily: BOLD, fontSize: RFValue(15), color: colors.text },
  habitItemSub: {
    fontFamily: REGULAR,
    fontSize: RFValue(12),
    color: colors.textSecondary,
  ...
  moodText: { fontFamily: SEMIBOLD, fontSize: RFValue(13), color: colors.textSecondary },
  ...
  saveBtnText: { fontFamily: BOLD, fontSize: RFValue(16), color: colors.surface },
});
